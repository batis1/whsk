...
class ConstructSentence extends React.Component {
  ...
  componentDidMount() {
    ...
    if (construct) {
      document
        .getElementById("skill-check-button")
        .setAttribute("data-guess", correct);
    }
  }
                  ...
                  <div className="construct-sentence-top-half" dir="ltr">
                    <div className="c-s-t-h-section">
                      ...
                      <div className="c-s-t-h-word-box">
                        {/* Toggled word buttons live here! */}
                      </div>
                    </div>
                  </div>

                  <div className="construct-sentence-bottom-half">{words}</div>
                </div>
              </div>
            </div>
          </div>
